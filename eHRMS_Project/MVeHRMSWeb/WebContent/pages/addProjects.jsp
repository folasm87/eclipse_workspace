		...
		<table width="100%" cellspacing="0" cellpadding="2" border="0">
			...
			<tr>
				...
				<td>
					...
					<logic:notEqual value="add" name="projectForm" property="action">
			...
			<tr>
				<td><bean:message key="project.table.header.column.category" />
				</td>
				<td><html:text styleClass="input_field" name="projectForm"
						property="category" />
				</td>
				...
				<td><bean:message
						key="project.table.header.column.businessObjective" /></td>
				<td><html:text styleClass="input_field" name="projectForm"
						property="businessObjective" />
				</td>
			</tr>
