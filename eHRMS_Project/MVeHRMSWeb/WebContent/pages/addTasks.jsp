...
<script type="text/javascript">
	$(function() {
	$("#newtask").validationEngine('attach');
	...
	function submitMe(){
	if($("#newtask").validationEngine('validate')){
	$("#newtask").submit();
...
<body>
	...
	<form id="newtask" action="/eHRMS/saveTasks.do?method=save"
		...
		<table width="100%" cellspacing="0" cellpadding="2" border="0">
			...
			<tr>
				...
				<td><logic:equal value="add" name="taskForm"
						...
						<html:text styleClass="input_field validate[required],custom(onlyNumber)" styleId="taskId" name="taskForm"
							property="taskId" />&nbsp;<font color="red">*</font>
					</logic:equal> <logic:notEqual value="add" name="taskForm" property="action">
						<bean:write name="taskForm" property="taskId" />
					</logic:notEqual></td>
			...
			<tr>
				<td><bean:message
						key="task.table.header.column.estimatedHours" /></td>
