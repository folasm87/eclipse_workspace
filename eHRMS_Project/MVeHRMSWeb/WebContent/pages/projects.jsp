...
<body id="dt_example">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td align="right"><p>
					<a href="/eHRMS/projects.do?method=add"><font color="black">
							<bean:message key="project.add.page.header" /> </font> </a>
				</p></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
	...
	<div id="container" style="width: 100%; align: left">
		<div id="demo_jui" style="width: 100%;">
			<table id="projects" class="display" width="100%" cellpadding="0"
				...
				<thead>
					<tr>
						<th><bean:message key="project.table.header.column.projid" />
						</th>
						<th><bean:message key="project.table.header.column.projname" />
						</th>
						<th><bean:message key="project.table.header.column.customer" />
						</th>
				
						<th><bean:message key="project.table.header.column.businessObjective" />
						</th>
						<th><bean:message key="project.table.header.column.category" />
						</th>
						<th><bean:message
								key="project.table.header.column.contractRefNo" /></th>
						<th><bean:message
								key="project.table.header.column.technologies" /></th>
						<th><bean:message
								key="project.table.header.column.estimatedHours" /></th>
						<th><bean:message
								key="project.table.header.column.estimatedCost" /></th>
						<th>&nbsp;</th>
					</tr>
				</thead>
				<tbody>
					...
					<logic:iterate id="proj" name="projects">
						<tr>
							<td><a
								href="/eHRMS/projects.do?method=edit&id=<bean:write name='proj' property='id' />"><font
							...
							<td><bean:write name="proj" property="businessObjective" /></td>
