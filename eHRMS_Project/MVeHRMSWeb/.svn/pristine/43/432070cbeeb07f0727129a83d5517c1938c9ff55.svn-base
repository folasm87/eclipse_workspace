...
<body>
	...
	<p>
	<form id="newemp" action="/eHRMS/employeesShift.do?method=list"
		method="post">
		...
		<table width="100%" cellspacing="0" cellpadding="2" border="0">
			...
			<tr>
				...
				<tr>
				<td><bean:message key="label.employee.id" />
				</td>
			...
			<tr>
				...
				<td colspan="4"><html:select styleClass="input_field"
			...
			<tr>
				...
				<td><html:text styleClass="input_field validate[required]" styleId="date" name="employeeShiftTime"
			...
			<tr>
				...
				<td><html:text styleClass="input_field validate[required]" styleId="hours" name="employeeShiftTime"
			...
			<tr>
				...
				<td><html:text styleClass="input_field validate[required]" styleId="jobDone" name="employeeShiftTime"
						 property="jobDone" />&nbsp;<font color="red">*</font>
				</td>
			</tr>
			...
			<tr>
				...
				<html:button property="save" styleClass="button_background" value="Close"
