...
<body id="dt_example">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td class="table_header" align="center">Leave Request Approval
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
	...
	<logic:notEqual value="HR" name="leaveRequestForm" property="userType">
	<tr>
	
	<td colspan="5" class="msg_bg"><bean:message key="leave.approval.previllage" />
	</td>
			
	</tr>
	</logic:notEqual>
	<logic:equal value="HR" name="leaveRequestForm" property="userType">
			...
			<table id="leaveRequest" class="display" width="100%" cellpadding="0"
				...
				<thead>
					<tr>
						...
						<th><bean:message key="leaverequest.table.status" /></th>
						<th>&nbsp;</th>
					</tr>
				</thead>
				<tbody>
					...
					<logic:iterate id="leave" name="leaveRequest">
						<tr>
							<td><a
								href="/eHRMS/leaveApproval.do?method=edit&id=<bean:write name='leave' property='id' />"><font
							...
							<td><a
								href="/eHRMS/leaveApproval.do?method=view&id=<bean:write name='leave' property='id' />"><font
