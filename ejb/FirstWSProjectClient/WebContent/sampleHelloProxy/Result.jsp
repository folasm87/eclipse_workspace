...
<jsp:useBean id="sampleHelloProxyid" scope="session" class="com.eintern.helloservice.HelloProxy" />
<%
...
case 10:
        gotMethod = true;
        com.eintern.helloservice.Hello getHello10mtemp = sampleHelloProxyid.getHello();
