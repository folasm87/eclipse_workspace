...
public class HelloServiceLocator extends org.apache.axis.client.Service implements com.eintern.helloservice.HelloService {
    ...
    private java.lang.String Hello_address = "http://localhost:7001/FirstWSProject/services/Hello";
    ...
    public com.eintern.helloservice.Hello getHello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.eintern.helloservice.HelloSoapBindingStub _stub = new com.eintern.helloservice.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.eintern.helloservice.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                com.eintern.helloservice.HelloSoapBindingStub _stub = new com.eintern.helloservice.HelloSoapBindingStub(new java.net.URL(Hello_address), this);
                _stub.setPortName(getHelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://helloservice.eintern.com", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://helloservice.eintern.com", "Hello"));
        }
